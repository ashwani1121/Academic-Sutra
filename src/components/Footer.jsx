    ...
    return (
        <footer className="bg-black text-gray-300 pt-12 sm:pt-16 pb-6 mt-16 font-sans">
            <div className="w-full max-w-[1440px] mx-auto px-[10px] sm:px-6 md:px-8 lg:px-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                {/* LEFT - CONTACT */}
                <div>
                    <h2 className="text-yellow-400 text-base sm:text-lg font-bold mb-2 tracking-wide uppercase">
                        Quick Contact Info
                    </h2>
                    <div className="w-10 h-[2px] bg-blue-500 mb-6"></div>
                    ...
                    <div className="mt-6 space-y-4 text-xs sm:text-sm">
                        ...
                        >
                            <MapPin className="text-yellow-400 mt-1 group-hover:text-blue-500 transition" size={18} />
                            <p className="group-hover:bg-gradient-to-r group-hover:from-yellow-400 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition duration-300">
                                SRM University AP, Guntur,<br /> Andhra Pradesh, India, 522 240
                            </p>
                        </a>

                        {/* EMAIL - Fixed responsive link */}
                        <a 
                            href="mailto:support@academicsutra.com" 
                            className="group flex items-center gap-2 transition duration-300 hover:translate-x-1"
                        >
                            <Mail className="text-yellow-400 group-hover:text-blue-500 transition" size={18} />
                            <p className="group-hover:bg-gradient-to-r group-hover:from-yellow-400 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition duration-300">
                                support@academicsutra.com
                            </p>
                        </a>

                        {/* PHONE - Fixed responsive link */}
                        <a 
                            href="tel:+916200998560" 
                            className="group flex items-center gap-2 transition duration-300 hover:translate-x-1"
                        >
                            <Phone className="text-yellow-400 group-hover:text-blue-500 transition" size={18} />
                            <p className="group-hover:bg-gradient-to-r group-hover:from-yellow-400 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition duration-300">
                                +(91) 6200998560
                            </p>
                        </a>
                        ...
                        {["No categories", "Conferences", "Upcoming Conferences", "E-Learning", "Global Research Opportunities"].map((item, i) => (
                            <li key={i}>
                                <Link to="#" className="group flex items-center gap-2 transition duration-300 hover:translate-x-1">
                                    <span className="text-gray-300 group-hover:bg-gradient-to-r group-hover:from-yellow-400 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition duration-300">
                                        {item}
                                    </span>
                                </Link>
                            </li>
                    ...
                    <div className="flex items-center gap-5 order-1 md:order-2">
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social, index) => (
                                ...
                                >
                                    {/* Circular Background Gradient Hover */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-500 to-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></div>
